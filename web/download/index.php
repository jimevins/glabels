...
<h2>System Requirements</h2>
<p>
The development version of gLabels is designed to run on <i>GNOME 2.24+</i>, but more specifically it requires the following libraries or newer.
</p>
<ul>
  <li>GTK+-2.14.x</li>
  <li>LIBXML-2.7.x</li>
  <li>LIBEBOOK-2.24.x (optional)</li>
</ul>
<p>
Note: to compile gLabels on most GNU/Linux systems, you will need the development packages (e.g., gtk2-devel or gtk2-dev)
installed for each of these libraries and their dependencies.
